      ...
      <div className="w-full lg:w-1/2 bg-white flex items-center justify-center p-8 lg:p-16">
        <div className="w-full max-w-[440px]">
          ...
          <div className="mt-6 text-center">
            ...
            <Link href="/sign-up" className="text-blue-600 hover:text-blue-700 font-medium text-sm">
              Sign up
            </Link>
          </div>
        </div>
        ...
        <div className="relative z-10 max-w-lg mx-auto px-12">
          <div className="text-center mb-16">
            ...
            <p className="text-lg text-white/95 leading-relaxed">
              Continue creating amazing 3D models with AI
            </p>
          </div>
          ...
          <div className="space-y-6">
            <div className="flex items-center gap-5">
              <div className="w-14 h-14 rounded-2xl bg-white/15 backdrop-blur-xl flex items-center justify-center flex-shrink-0 border border-white/20 shadow-lg">
                <FolderOpen className="w-7 h-7 text-white" strokeWidth={1.5} />
              </div>
              <span className="text-xl font-medium text-white">Access Your Library</span>
            </div>
            <div className="flex items-center gap-5">
              <div className="w-14 h-14 rounded-2xl bg-white/15 backdrop-blur-xl flex items-center justify-center flex-shrink-0 border border-white/20 shadow-lg">
                <Play className="w-7 h-7 text-white" strokeWidth={1.5} />
              </div>
              <span className="text-xl font-medium text-white">Resume Your Projects</span>
            </div>
            <div className="flex items-center gap-5">
              <div className="w-14 h-14 rounded-2xl bg-white/15 backdrop-blur-xl flex items-center justify-center flex-shrink-0 border border-white/20 shadow-lg">
                <Sparkles className="w-7 h-7 text-white" strokeWidth={1.5} />
              </div>
              <span className="text-xl font-medium text-white">Create More Models</span>
            </div>
          </div>
        </div>
      </div>
