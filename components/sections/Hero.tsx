  ...
  return (
    <>
      <section className="relative min-h-screen w-full overflow-hidden bg-neutral-900">
        ...
        <div className="relative z-10 flex flex-col items-center justify-center min-h-screen px-4 sm:px-6 md:px-8 py-24 sm:py-32">
          <div className="mx-auto w-full max-w-3xl flex flex-col items-center gap-6 sm:gap-8">
            ...
            <p
              className="text-white text-center max-w-2xl font-medium tracking-tight drop-shadow-sm text-base sm:text-lg md:text-xl leading-snug"
              style={{ fontFamily: "var(--font-dm-sans), DM Sans, sans-serif" }}
            >
              AI-powered 3D generation for creators, studios, and platforms.
            </p>

            {/* Segmented control: Create | Book Demo - professional hover, no glow */}
            <div className="flex p-1 rounded-full bg-white/10 backdrop-blur-sm border border-white/20">
              <button
                type="button"
                onClick={() => setMode("create")}
                className="relative px-5 sm:px-6 py-2.5 rounded-full text-sm font-medium text-white transition-colors duration-200 hover:bg-white/10 focus:outline-none focus-visible:ring-2 focus-visible:ring-white/40 focus-visible:ring-offset-2 focus-visible:ring-offset-transparent"
              >
                {mode === "create" && (
                  <motion.div
                    layoutId="hero-segment"
                    className="absolute inset-0 rounded-full bg-white/15 border border-white/25"
